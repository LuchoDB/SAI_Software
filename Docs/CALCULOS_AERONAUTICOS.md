...
> *Ruta: `Docs/CALCULOS_AERONAUTICOS.md`*  
> *Base matemática y física para los motores de cálculo del sistema SAI Consult.*
...
*Ejemplo*: Rumbo verdadero $042^\circ$, declinación $-8^\circ$ (W) $\implies MH = 042 - (-8) = 050^\circ \implies QFU = 05 / 23$.
